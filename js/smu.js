...
function updateMobileOffset()
{
  ...
  {
    mobileOffset = 35;
    talksMobileOffset=50;
    schoolboothOffset=50;
    console.log("Screen:Small:Offset"+offset);
  }
}
...
$(function() 
{
  ...
  $('a[href*="#"]:not([href="#"])').click(function() 
  {
    ...
    {
     $('html, body').animate({
           scrollTop:  $('.container.section_5.section_bg .section_gra .section_title .inner').first().offset().top - ($('.container.section_5.section_bg .section_gra .section_title .inner div').height()+$('.container.section_5.section_bg .section_gra .section_title .inner div').height()/1+mobileOffset),
       }, 1000);
